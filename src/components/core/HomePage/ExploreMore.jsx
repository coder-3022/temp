...
const ExploreMore = () => {
  ...
  return (
    <div>
        ...
        <div className=' hidden gap-5 mt-5 mx-auto lg:flex w-max rounded-full font-medium bg-richblack-800 mb-3
         border-richblack-200 p-1 drop-shadow-[0_1.5px_rgba(255,255,255,0.25)]'>
            {
                tabsName.map( (element, index) => {
                    return(
                        ...
                        hover:bg-richblack-900 hover:text-richblack-5 px-7 py-[7px]`} key={index}
        ...
        <div className='lg:absolute gap-10 justify-center lg:gap-0 flex lg:justify-between flex-wrap w-full lg:bottom-[0]
         lg:left-[50%] lg:translate-x-[-50%] lg:translate-y-[50%] text-black lg:mb-0  lg:px-0 px-3'>
            {
